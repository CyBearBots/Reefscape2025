...
import edu.wpi.first.math.geometry.Pose3d;   //It says this is never used
...
import edu.wpi.first.wpilibj.DriverStation.Alliance;  //It says this is never used
...
public class SwerveSubsystem extends SubsystemBase
{
   ...
   */
  private final AprilTagFieldLayout aprilTagFieldLayout = AprilTagFieldLayout.loadField(AprilTagFields.k2025Reefscape);  //It says this is never used
  /**
  ...
  public void setupPathPlanner()
  {
    ...
    try
    {
      ...
      AutoBuilder.configure(
          swerveDrive::getPose,   //used to be this
          // Robot pose supplier
          swerveDrive::resetOdometry, //used to be this
          // Method to reset odometry (will be called if your auto has a starting pose)
          swerveDrive::getRobotVelocity, //used to be this
